...
public class CSVReader : MonoBehaviour
{
    ...
    public static List<Dictionary<string, object>> Read(string CarMovement) //Declare method
    {
        ...
        TextAsset data = Resources.Load(CarMovement) as TextAsset; //Loads the TextAsset named in the file argument of the function
